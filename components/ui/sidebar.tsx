  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Spacer that reserves the sidebar's width in normal flow. */}
        <div
          className={cn(
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 font-mono text-[10px] font-medium uppercase tracking-[0.13em] text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-[margin,opacity] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
